...
card_t card_from_num(unsigned c) {
  ...
  case 1 : temp.value = 2; break;
  case 2 : temp.value = 3; break;
  case 3 : temp.value = 4; break;
  case 4 : temp.value = 5; break;
  case 5 : temp.value = 6; break;
  case 6 : temp.value = 7; break;
  case 7 : temp.value = 8; break;
  case 8 : temp.value = 9; break;
  case 9 : temp.value = 10; break;
  case 10 : temp.value = VALUE_JACK; break;
  case 11 : temp.value = VALUE_QUEEN; break;
  case 12 : temp.value = VALUE_KING; break;
  }
